---
layout: post
title: Building and Leveling Up a Computer Scientist Résumé as a Recently Graduated PhD Student 
...
This includes what content to add what to skip, its structure, and what I believe are common mistakes to avoid.
...
Beyond listing your technical skills and work experience, I suggest including elements that demonstrate commitment to the field.
For example, for me, showing that you have taught someone in some course (even if it is for children) or contribute to some really popular open-source project (10K stars or more on GitHub) means that you are driven not only for money but that you really have a love for the profession.
It means that you’re giving something back to the community.
...
I think the world has changed fundamentally in the last decades.
Consider two persons with the same grades and same qualifications.
One of them applies for a job with the traditional ~~boring~~ resumé, she jumped from company `X` to `Y` to `Z` every 3 to 5 years.
Now the other has published research papers, been reached on the local media, and has 100K followers.
Which one do you think has more changes to get the job?
The answer (I think) is the second person.
And the reason is not the number of followers.
It's the original, valuable, content that this person has already proven that she can create.
This person has already practiced and been validated, in public.
(Before the internet the validator was the neighbour).
