...
tags: science
description: |
  The last paper's myth emerges where academic supervisors realize that a student is about to get the PhD and leave. It's one last stronghold to capitalize on the time and effort they have put into their students' scientific training. This relentless push not only detracts from the true purpose of academic research but also imposes significant personal and mental strain on the most successful students. This article explores the expectations versus reality at the end of the PhD journey and provides actionable insights for researchers on how to identify, address, and navigate this particular pressure.
keywords:
  - PhD student
  - academic pressure
...
The truth is, I know she has many papers published already, so why the need for one more?
Why such unnecessary pressure at the end of the PhD?
...
It's not the first time I encounter this scenario, and it won't be the last.
...
My intention is to provide actionable insights for researchers on how to identify, address, and navigate this particular pressure.
...
For most PhD students, the doctoral journey is envisioned as a quest for [knowledge and further opportunities](../blog/seven-reasons-to-go-for-a-phd-in-computer-science.html).
It's a personal challenge, where intellectual curiosity meets the rigorous demands of [scientific research methodologies](https://en.wikipedia.org/wiki/Scientific_method).
This idyllic vision of fulfilled scientists, however, has evolved dramatically over the years.
...
They seemed to push the boundaries of human knowledge a bit.
In such a position, it was reasonable for me to assume that **I should focus only on writing my thesis**.
...
> "The last paper's myth emerges where academic supervisors realize that the student is about to get the PhD and leave. It's one last stronghold to capitalize on the time and effort they have put into their students' scientific training."
...
In science, measuring productivity and impact through raw metrics such as the number of papers published or citations has proven to be extremely difficult.
...
Not to forget that academic supervisors already decided (probably a long time ago) to stay in academia, so they have a vested interest in maintaining their publication record.
...
Recent studies indicate that while some [students benefit from the additional push](https://link.springer.com/article/10.1007/s10734-019-00473-6), gaining increased publications and enhanced resumes, others feel [exploited and stretched too thin](https://link.springer.com/article/10.1007/s12529-020-09867-8).
...
This unplanned work involves receiving feedback from peer reviewers, addressing their comments, and submitting revisions, a process that can extend several months post-graduation.
...
You can let him know that you're really stressed and that you need to focus on your thesis.
Take into account that your supervisors are extremely intelligent people.
They know very well how much they can push, and if they push too much, they could provoke a burnout that is not beneficial for anyone.
So, it is in their best interest to keep you in good shape.

Settled accounts keep old friends.
I would try to negotiate upfront the number of papers that are necessary and keep to this number, then send it to your supervisor.
It might be worth saying something like this:
...
However, sometimes supervisors might see this as a preventive sign of potential future conflicts.
...
By making it clear that you are in "thesis writing mode," and therefore unable to take on additional tasks, you can create a shield that will protect you from any pressure to write that last "unexpected" paper.

# Extrapolations Beyond Academia
...
As project deadlines get closer, managers tend to oppress these employees to maximize output.
...
I think there is a need for institutions (corporate, academic, or otherwise) to reassess their policies and practices to ensure they promote more supportive work environments.

# Conclusions

We delved into what I call "the last paper's myth," a situation that drives academic supervisors to exercise extra pressure in the last year of their PhD students.
It's a matter of contending interests, where the students' need for completion clashes with the academic system's drive for continuous output.
...
So, the mere fact of being pressured at the end is synonymous with success.
...
In any case, I believe that clear and measurable expectations should be put in place to ensure a happy ending regardless of the professional field.
