...
The field of Generative Artificial Intelligence (GenAI) has made incredible strides in recent years, particularly in [source code analysis and generation](https://ml4code.github.io/papers).
...
Over the past few months, I’ve attended several academic and [industrial conferences](https://www.linkedin.com/posts/cesarsotovalero_ai-sweden-activity-7255582747417571328-oGDN) and read a plethora of [research papers on this topic](https://ml4code.github.io/papers).
...
This distinction is vital: GenAI excels at recombination of existing knowledge, but genuine [innovation](https://en.wikipedia.org/wiki/Innovation) (i.e., the ability to transform abstract ideas into novel practical solutions that deliver unique value) requires more than that.[^2]
...
This is because [architecture](./blog/what-does-it-take-to-become-a-software-architect) is not just about choosing the right tools or patterns, it’s about understanding the problem space, anticipating future needs, and making informed trade-offs decisions.

As I mentioned in a [previous blog post](./blog/ai-doesnt-make-me-the-same-coffee), GenAI powered tools are not a silver bullet.
...
The natural assumption might be to scale up with advanced [microservices](./blog/design-for-microservices) and expensive infrastructure to ensure immediate response times.
...
Focus on learning [the skills](./blog/surviving-the-ai-revolution-as-a-software-engineer) that only humans can master.
...
[^2]: Billings, Jay Jay, et al. 2017 "Will humans even write code in 2040 and what would that mean for extreme heterogeneity in computing?", [in arXiv](https://arxiv.org/pdf/1712.00676).
