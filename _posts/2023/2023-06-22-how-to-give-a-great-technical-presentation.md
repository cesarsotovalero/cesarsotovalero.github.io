...
I recommend going over the following list of don't after you have prepared your slides:
...
- What I saw from everyone is that they were inspired when someone exhibited passion about what they were doing
...
- **Why do you want to be recognized for what you do?**. None gets used to be ignored. Your ideas are like your children. And you don't want them to go into the world in rags. So what you want to do is to be sure that you have these techniques, these mechanisms, these thoughts about how to present ideas that you have so that they're recognized for the value that is in them. So that's why it's a legitimate thing to concern yourself with packaging. 
 
- **How do you get remembered?** One of the things you need to do is to make sure that you have some kind of **symbol** associated with your work. Next thing you need is some kind of **slogan**, a kind of phrase that provides a handle on the work. And now we need a **surprise**. Next item was a **salient idea**. An idea that sticks out. Some theses, funnily enough, have too many good ideas, and you don't know what it's all about because which one is it? So you need an idea that sticks out. And finally, you need to **tell the story of how you did it, how it works, why it's important**.

# How to finish

- **What is in the final slide?** It's an opportunity for you to tell people who you are and what you have done. And that's why your final slide should have this label, contributions.

- **What are the final words?** One thing you could do in the final words is you could tell a joke. By the time you're done, people have adjusted themselves to your voice parameters. They're ready for a joke, and that way, people think they've had fun the whole time.

> Finishing with "Thank you" is a weak move. When you say thank you, even worse, thank you for listening, it suggests that everybody has stayed that long out of politeness and that they had a profound desire to be somewhere else. But they're so polite, they stuck it out. And that's what you're thanking them for. So once wild applause has started, you can mouth a thank you, and there's nothing wrong with that. But the last thing you do should not be saying thank you.

You can salute the audience, and you can say something about how much you value your time at a place. So I could say, well, "it's been great fun being here. I've been much stimulated and provoked by the kinds of questions you've been asking, it's been really great. And I look forward to coming back on many occasions
  in the future." So that salutes the audience. 
...
Understanding that how you present and how you package your ideas is an important thing.
