...
<div class="links-container">
  ...
  <div class="cards-section">
    <!-- About Me Card -->
    <a href="https://www.cesarsotovalero.net/about-me" class="link-card" target="_blank" rel="noopener noreferrer">
      <div class="card-icon">
    ...
    <!-- GitHub Card -->
    <a href="https://github.com/cesarsotovalero" class="link-card" target="_blank" rel="noopener noreferrer">
      <div class="card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="card-text">GitHub Page</div>
    </a>
  </div>
  ...
  <div class="flex-container-footer-copyright">
    <p class="copyright text-muted">
      &copy; {{ site.author.name }}&nbsp;&nbsp;&bull;&nbsp;&nbsp;2018&ndash;{{ site.time | date: '%Y' }}
    </p>
  </div>
</div>
